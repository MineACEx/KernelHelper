package com.kernelhelper.acex.magica;

import static com.kernelhelper.acex.magica.AppZygotePreload.TAG;
...
import com.kernelhelper.acex.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.kernelhelper.acex.magica.LAUNCH".equals(action)) {
            return;
        }
